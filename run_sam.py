...
argparser.add_argument('--queries_path', type=str, default='results/instances_Base_cityscapes_BT_0.2_TT_0.15.pkl', help='Path to the grounding instances. Default is results/instances_Base_cityscapes_BT_0.2_TT_0.15.pkl.')
